...
def callback(data):
    ...
    [yaw, pitch, roll] = quaternion_to_euler(pos_msg.orientation.x, pos_msg.orientation.y, pos_msg.orientation.z,
    ...
    velocity = [Velocity_msg.linear.x, Velocity_msg.linear.y, Velocity_msg.linear.z, Velocity_msg.angular.x,
                Velocity_msg.angular.y, Velocity_msg.angular.z]
    flag_cont = 1
...
def callback_Init(data):
    ...
    velocity_0 = [Velocity_msg_0.linear.x, Velocity_msg_0.linear.y, Velocity_msg_0.linear.z, Velocity_msg_0.angular.x,
                  Velocity_msg_0.angular.y, Velocity_msg_0.angular.z]
    flag_initial = 1
...
for i in range(img.size[0]):
    for j in range(img.size[1]):
        ...
        if (i == 58 or i == 59 or i == 60 or i == 61 or i == 62) and j >= 18 and j <= 32:
            pixels[i, j] = 0;
